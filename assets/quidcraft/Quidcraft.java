...
public class Quidcraft {
	...
	public static int Quaffle_ID, Bludger_ID, Snitch_ID, Bat_ID, Broom_ID, BludgerGlove_ID, SnitchGlove_ID, Jersey_ID, Headband_ID;
	...
	public void loadQuidditch(FMLInitializationEvent event) {
		...
		GameRegistry.addRecipe(new ItemStack(Bat), new Object[] { "  w", " w ", "s  ", Character.valueOf('s'), Item.stick, Character.valueOf('w'), Block.planks });
		/* Bludger */
		...
		GameRegistry.addRecipe(new ItemStack(Bludger), new Object[] { " i ", "ibi", " i ", Character.valueOf('i'), Item.ingotIron, Character.valueOf('b'), Item.bone });
		/* Bludger Glove */
		...
		GameRegistry.addRecipe(new ItemStack(BludgerGlove), new Object[] { "i i", Character.valueOf('i'), Item.ingotIron });
		/* Broom */
		...
		GameRegistry.addRecipe(new ItemStack(Broom), new Object[] { "  s", " s ", "w  ", Character.valueOf('s'), Item.stick, Character.valueOf('w'), Item.wheat });
		/* Quaffle */
		...
		GameRegistry.addRecipe(new ItemStack(Quaffle), new Object[] { " l ", "l l", " l ", Character.valueOf('l'), Item.leather });
		/* Snitch */
		...
		GameRegistry.addRecipe(new ItemStack(Snitch, 1), new Object[] { "fgf", Character.valueOf('g'), Item.ingotGold, Character.valueOf('f'), Item.feather });
		/* Snitch Glove */
		...
		GameRegistry.addRecipe(new ItemStack(SnitchGlove), new Object[] { "l l", Character.valueOf('l'), Item.leather });
		/* Jerseys */
		for (int i = 0; i < jerseyNames.length; i++) {
			...
			for (int j = 0; j < jerseyNames.length && j != i; j++) {
				GameRegistry.addShapelessRecipe(new ItemStack(Jersey[i]), new Object[] { new ItemStack(Jersey[j]), new ItemStack(Item.dyePowder, 1, i) });
			}
		}
		GameRegistry.addRecipe(new ItemStack(Jersey[0]), new Object[] { "c c", "ccc", "ccc", Character.valueOf('c'), Block.cloth });
		/* Headbands */
		for (int i = 0; i < headbandNames.length; i++) {
			...
			for (int j = 0; j < headbandNames.length && j != i; j++) {
				GameRegistry.addShapelessRecipe(new ItemStack(Headband[i]), new Object[] { new ItemStack(Headband[j]), new ItemStack(Item.dyePowder, 1, i) });
			}
		}
		GameRegistry.addRecipe(new ItemStack(Headband[0]), new Object[] { "ccc", Character.valueOf('c'), Block.cloth });
		/* Goal Block */
		...
		GameRegistry.addRecipe(new ItemStack(BlockGoal, 5), new Object[] { "c c", " c ", "c c", Character.valueOf('c'), Block.cloth });
		...
		GameRegistry.addRecipe(new ItemStack(QuidditchChest), new Object[] { " q ", "bcb", " s ", Character.valueOf('q'), Quaffle, Character.valueOf('b'), Bludger, Character.valueOf('s'), Snitch,
			Character.valueOf('c'), Block.chest });
		/* Boundary Flag */
		BoundaryFlag = new BlockFlag(BoundaryFlag_ID).setHardness(2.5F).setStepSound(Block.soundWoodFootstep).setUnlocalizedName("quidcraft:Flag").setTextureName("quidcraft:Flag");
		GameRegistry.registerBlock(BoundaryFlag, "Boundary Flag");
		LanguageRegistry.addName(BoundaryFlag, "Boundary Flag");
		GameRegistry.addRecipe(new ItemStack(BoundaryFlag), new Object[] { "wws", "wws", "  s", Character.valueOf('w'), Block.cloth, Character.valueOf('s'), Item.stick });
		/* Score Area Flag */
		ScoreAreaFlag = new BlockFlag(ScoreAreaFlag_ID).setHardness(2.5F).setStepSound(Block.soundWoodFootstep).setUnlocalizedName("quidcraft:ScoreAreaFlag").setTextureName("quidcraft:ScoreAreaFlag");
		GameRegistry.registerBlock(ScoreAreaFlag, "Score Area Flag");
		LanguageRegistry.addName(ScoreAreaFlag, "Score Area Flag");
		GameRegistry.addShapelessRecipe(new ItemStack(ScoreAreaFlag), new Object[] { BoundaryFlag, new ItemStack(Item.dyePowder, 1, 1) });
		GameRegistry.addShapelessRecipe(new ItemStack(BoundaryFlag), new Object[] { ScoreAreaFlag, new ItemStack(Item.dyePowder, 1, 15) });
	}
