...
public class QuidcraftTickHandler implements ITickHandler {
	...
	public boolean onTickInGUI(float f, Minecraft minecraft, GuiScreen guiscreen) {
		if ((guiscreen instanceof GuiContainerCreative) && !(lastGuiOpen instanceof GuiContainerCreative) && !minecraft.theWorld.isRemote) {
			...
			/*
			 * List list = ((ContainerCreative)container).itemList; int i = 0;
			 * list.add(new ItemStack(QuidditchChest, 1, i)); list.add(new
			 * ItemStack(BlockGoal, 1, i)); list.add(new ItemStack(BoundaryFlag,
			 * 1, i)); list.add(new ItemStack(ScoreAreaFlag, 1, i));
			 */
