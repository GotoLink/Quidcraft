...
public class ItemBroom extends Item{
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
    {
        ...
        double var9 = entityplayer.prevPosY + (entityplayer.posY - entityplayer.prevPosY) + 1.62D - (double)entityplayer.yOffset;
        ...
        else
        {
            ...
            boolean var26 = false;
            List var28 = world.getEntitiesWithinAABBExcludingEntity(entityplayer, entityplayer.boundingBox.addCoord(var25.xCoord * var21, var25.yCoord * var21, var25.zCoord * var21).expand(1.0D, 1.0D, 1.0D));
            int var29;
            ...
            else
            {
                if (var24.typeOfHit == EnumMovingObjectType.TILE)
                {
                    ...
                    EntityBroom var35 = new EntityBroom(world, (double)((float)var29 + 0.5F), (double)((float)var33 + 1.0F), (double)((float)var34 + 0.5F));
                    var35.rotationYaw = (float)(((MathHelper.floor_double((double)(entityplayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
